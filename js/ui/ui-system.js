(() => {
    ...
    function initializeLayout() {
        ...
        if (elements.instructions) {
            elements.instructions.textContent = 'Кликайте по клеткам, чтобы строить маршрут. Нажмите "Ходить" для подтверждения пути. Пробел тоже запускает движение. Тропа и мосты экономят силы, тростник и осыпь утяжеляют путь, а грязь и хрупкие мосты лучше обходить.';
        }
        markDirty();
    }
